-- Analytics and Business Intelligence Database Enhancements - Fixed
...
-- Revenue analytics materialized view (fixed enum values)
...
SELECT 
    ...
    COUNT(CASE WHEN c.status = 'in_progress' THEN 1 END) as in_progress_campaigns,
