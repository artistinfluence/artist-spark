...
('Test Artist One', 'artist1@test.com', ARRAY['artist1@test.com', 'artist1.alt@test.com'], 'active', 'T2', 4),
('Test Artist Two', 'artist2@test.com', ARRAY['artist2@test.com'], 'active', 'T1', 4),
('Test Artist Three', 'artist3@test.com', ARRAY['artist3@test.com'], 'active', 'T3', 6)
...
SELECT 'House', gf.id, ARRAY['house', 'deep house', 'tech house'], true, 1
FROM public.genre_families gf WHERE gf.name = 'Electronic'
UNION ALL
SELECT 'Techno', gf.id, ARRAY['techno', 'minimal techno'], true, 2
FROM public.genre_families gf WHERE gf.name = 'Electronic'
UNION ALL
SELECT 'Trap', gf.id, ARRAY['trap', 'trap music'], true, 1
