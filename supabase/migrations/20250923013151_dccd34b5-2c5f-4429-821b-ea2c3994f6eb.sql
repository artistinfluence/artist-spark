...
ADD COLUMN IF NOT EXISTS weekly_reporting_enabled boolean DEFAULT false;

-- Insert basic soundcloud clients (using existing schema)
INSERT INTO soundcloud_clients (id, name, email) VALUES
('11111111-1111-1111-1111-111111111111', 'Atlantic Records', 'campaigns@atlantic.com'),
('22222222-2222-2222-2222-222222222222', 'Spinnin Records', 'promo@spinninrecords.com'),
('33333333-3333-3333-3333-333333333333', 'Independent Artist', 'sarah@sarahmusic.com'),
('44444444-4444-4444-4444-444444444444', 'Monstercat', 'marketing@monstercat.com'),
('55555555-5555-5555-5555-555555555555', 'OWSLA Records', 'team@owsla.com')
