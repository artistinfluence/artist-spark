...
-- Create soundcloud_clients table if it doesn't exist
CREATE TABLE IF NOT EXISTS soundcloud_clients (
...
-- Insert mock soundcloud clients
INSERT INTO soundcloud_clients (id, name, email, company, phone, notes) VALUES
